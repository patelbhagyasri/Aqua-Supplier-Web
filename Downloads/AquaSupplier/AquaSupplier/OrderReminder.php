...
<div class="w3-container w3-display-container">
	...
	<div class="modal-content" style="margin-top:50px;">
		...
		<p style="color:#000; font-weight:bold;font-size:17px;">Order Reminder</p>
		</div>
		...
		<?php
		$today=date('Y-m-d');
		$result=mysql_query("select * from order_info where order_date = '$today'");
		...
		<tr>
			...
			<td><center><a href="?id=<?php echo $row[0];?>" onclick="return confirm('Are You Sure ? ');"><span class="glyphicon glyphicon-trash" style="color:red;"></span></a></center></td>
		</tr>
		<?php
		}
	?>
