        ...
        <div class="modal-header">
         ...
         <p style="color:#000; font-weight:bold;font-size:17px;">Add New Customer</p>
			...
			<div class="col-sm-2">
				...
				<div class="col-sm-2">
					House No
						<input type="text" class="form-control input-sm" name="txtHouseNo" id="txtHouseNo" placeholder="House No" required tabindex="4" />
			...
			<div class="row">
				...
				<div class="col-sm-1">
					&nbsp;
              <button type="submit" class="btn btn-primary btn-block" name="btnSave" id="btnSave" tabindex="11"><span class="glyphicon glyphicon-plus"></span> Add</button>
					 ...
					 <?php
						...
						while($rowPlanName=mysql_fetch_array($getPlanName))
						{
							...
							'$pos_order','".$_POST['txtHouseNo']."','active','".$_POST['txtProductName']."','".$_POST['txtDepositeAmt']."',
		...
		<div class="modal-body" style="padding:10px 10px;">
			...
			<table class="table table-bordered" style="font-size:12px;">
				...
				mysql_query("set names utf8");
					...
					cm.house_no,cm.product,cm.deposite_amt,cm.deposite_type,pm.plan_name,cm.plan_rate from customer_master cm,truck_master tm,plan_master pm where pm.plan_id=cm.plan_id and cm.truck_id=tm.truck_id and cm.status='active'");
