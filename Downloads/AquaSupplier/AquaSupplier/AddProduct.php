	...
	<div class="modal-content" style="margin-top:50px;">
			...
			<div class="row">
				<div class="col-sm-5">
					<div class="input-group">
					  ...
					  <input type="text" class="form-control" name="txtPlan" id="txtPlan" placeholder="Product Name" required tabindex="1" />
					</div>
				</div>
				<!--<div class="col-sm-5">
					<div class="input-group">
				...
				<div class="col-sm-2">
					<button type="submit" class="btn btn-danger btn-block" name="btnSave" id="btnSave" tabindex="3"><span class="glyphicon glyphicon-plus"></span> Add New Product</button>
				</div>
			...
			<div class="row">
				 <?php
						...
						{  mysql_query("set names utf8");
							$i=mysql_query("insert into product_master (product_name) values ('".strtoupper($_POST['txtPlan'])."')");
							if($i>0)
							{
		...
		<div class="modal-body" style="padding:10px 10px;">
				  ...
				  mysql_query("set names utf8");
					...
					while($row=mysql_fetch_array($result))
					{
						...
						<tr>
							...
							<td><center><a href="editProduct.php?pid=<?php echo $row[0]; ?>" style="color:#1B5E20;" > Edit </a> </center></td>	
						</tr>
						<?php
					}
				?>	
			...
			<?php
				...
				{
					mysql_query("delete from product_master where product_id='".$_REQUEST['id']."'");
