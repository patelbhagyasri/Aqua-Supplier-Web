...
array_push($result,
array('customer_id'=>$customer_id,'truck_id'=>$truck_id,'customer_name'=>$customer_name,'contact'=>$contact,'address'=>$address,'supplied_qty'=>$supply_qty,'rec_amt'=>$dep_amt,'old_due'=>$old_due,'total_due'=>$total_due,'plan_name'=>$plan));
